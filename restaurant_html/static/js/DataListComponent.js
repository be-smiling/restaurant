...
<div class="model_list">
    <div class="button_group line">
        <el-button size="mini" type="primary" plain v-if="onAddNewForm" @click="addNewForm" >新建</el-button>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <slot>
            <tr v-for="item in modelList">
                 ...
                 <td v-if="option">
                    <el-button type="success" size="mini" v-if="onEditForm" @click="editForm(item)" >编辑</el-button>
                    <el-button type="danger" size="mini" v-if="deleteApiUrl" @click="del(item)" >删除</el-button>
                 </td>
            </tr>
        </slot>
    </table>
