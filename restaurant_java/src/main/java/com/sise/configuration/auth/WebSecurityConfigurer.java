...
import com.sise.components.DynamicPermission;
...
//                .antMatchers(HttpMethod.POST,"/user/register").permitAll()
                .antMatchers("/user/register", "/weChat/notify").permitAll()
                //动态加载资源
...
//        //拦截token，并检测。在 UsernamePasswordAuthenticationFilter 之前添加 TokenAuthenticationFilter
