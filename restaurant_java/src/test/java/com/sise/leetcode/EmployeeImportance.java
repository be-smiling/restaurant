...
public class EmployeeImportance {
            ...
            if (employees.get(i).id == id){
                ...
                for (int i1 = 0; i1 < employees.get(i).subordinates.size(); i1++) {
                    for (int i2 = 0; i2 < employees.size(); i2++) {
                        Integer integer = employees.get(i).subordinates.get(i1);
                        int id1 = employees.get(i2).id;
                        if (integer == id1){
                            importance += employees.get(i2).importance;
                        }
                    }
                }
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getImportance(aa, 1));
    }
}
